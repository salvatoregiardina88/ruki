...
internal static class Strings
{
    ...
    private static readonly Dictionary<string, (string It, string En)> Table = new(StringComparer.Ordinal)
    {
        ...
        // Descrizione localizzata dell'azione rischiosa (il punto del click è mostrato col cerchio rosso).
        ["Confirm_ActClick"] = ("fare clic nel punto evidenziato in rosso", "click the spot highlighted in red"),
        ["Confirm_ActScroll"] = ("scorrere nel punto evidenziato in rosso", "scroll at the spot highlighted in red"),
        ["Confirm_ActType"] = ("digitare: \"{0}\"", "type: \"{0}\""),
        ["Confirm_ActKey"] = ("premere i tasti: {0}", "press the keys: {0}"),
        ["Confirm_ActOther"] = ("eseguire un'azione sul computer", "perform an action on the computer"),
        ["Common_Yes"] = ("Sì", "Yes"),
        ["Common_No"] = ("No", "No"),
